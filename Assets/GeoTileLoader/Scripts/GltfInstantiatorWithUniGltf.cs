...
//
// 以下のパッケージをインポートする
//  * https://github.com/vrm-c/UniVRM.git?path=/Assets/UniGLTF#v0.124.2
//  * https://github.com/vrm-c/UniVRM.git?path=/Assets/VRMShaders#v0.124.2
//
...
namespace GeoTile
{
    ...
    public class GltfInstantiatorWithUniGltf : IGltfInstantiator
    {
        ...
        private async void LoadGltfWithUniGLTF(byte[] data, Transform parent, Action<GameObject> onResult)
        {
